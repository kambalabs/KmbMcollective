...
use KmbMcollective\Model\McollectiveLogDiscoveredInterface;
use KmbMcollective\Model\McollectiveLogDiscoveredRepositoryInterface;
use Zend\Db\Sql\Predicate\Predicate;

class McollectiveLogDiscoveredRepository extends Repository implements McollectiveLogDiscoveredRepositoryInterface
{
     ...
     * @return McollectiveLogInterface
     */
    public function getDiscoveredNodesByActionid($actionid)
    {
     ...
     * @return array
     */
    public function getAllByHostname($hostname)
    {
